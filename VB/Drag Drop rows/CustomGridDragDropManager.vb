...
Namespace Drag_Drop_rows
    ...
    Public NotInheritable Class GetRowImagesHelper
        Public Shared Function GetRowImages(view As DataViewBase) As List(Of Object)
            Dim images As New List(Of Object)()
            For Each rowHandle As Integer In view.DataControl.GetSelectedRowHandles()
                ...
                If element IsNot Nothing Then
                    ...
                    Dim bmp As New RenderTargetBitmap(CInt(element.ActualWidth), CInt(element.ActualHeight), 96, 96, PixelFormats.Pbgra32)
                    bmp.Render(element)
                    images.Add(New Image() With {
                        .ImageSource = bmp,
